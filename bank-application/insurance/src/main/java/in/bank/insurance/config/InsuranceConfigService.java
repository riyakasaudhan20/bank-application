package in.bank.insurance.config;
...
public class InsuranceConfigService {
	...
	public String toString() {
		return "InsuranceConfigService [msg=" + msg + ", buildVersion=" + buildVersion + ", mailDetails=" + mailDetails
